...
- [ ] **v0.9.0** — Benchmarks (HaluEval, TruthfulQA), real LLM integration tests (Claude, GPT-4o), batch verification (1000+ claims), property-based testing (Hypothesis), Violation Analytics, Metacognition benchmark suite
